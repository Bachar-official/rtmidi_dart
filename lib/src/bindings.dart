// Auto-generated from bundled RtMidi 6.0.0 (MIT License)
...
class RtMidiFFI {
  ...
  ffi.Pointer<ffi.Char> rtmidi_get_version() {
    return _rtmidi_get_version();
  }

  late final _rtmidi_get_versionPtr =
      _lookup<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function()>>(
          'rtmidi_get_version');
  late final _rtmidi_get_version =
      _rtmidi_get_versionPtr.asFunction<ffi.Pointer<ffi.Char> Function()>();
...
abstract class RtMidiApi {
  ...
  /// !< W3C Web MIDI API.
  static const int RTMIDI_API_WEB_MIDI_API = 6;

  /// !< The Microsoft Universal Windows Platform MIDI API.
  static const int RTMIDI_API_WINDOWS_UWP = 7;

  /// !< The Android MIDI API.
  static const int RTMIDI_API_ANDROID = 8;

  /// !< Number of values in this enum.
  static const int RTMIDI_API_NUM = 9;
}
